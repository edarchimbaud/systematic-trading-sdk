...
from . import pos
from ..metrics import cum_returns
...
def apply_slippage_penalty(
    returns, txn_daily, simulate_starting_capital, backtest_starting_capital, impact=0.1
):
    """
    ...
    portfolio_value = (
        cum_returns(returns, starting_value=backtest_starting_capital) * mult
    )
